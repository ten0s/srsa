...
deque_test() ->
    ...
    RLQ2 = {[1], [2]} = in_r(2, RLQ1),
    RLQ3 = {[1], [3,2]} = in_r(3, RLQ2),
    ?assertEqual(1, peek_l(RLQ3)),
    {1, RLQ4 = {[2], [3]}} = out_l(RLQ3),
    RLQ5 = {[2], [4,3]} = in_r(4, RLQ4),
    {2, RLQ6} = out_l(RLQ5),
    {3, RLQ7 = {[], [4]}} = out_l(RLQ6),
    {4, RLQ8} = out_l(RLQ7),
    ...
    LRQ2 = {[2], [1]} = in_l(2, LRQ1),
    LRQ3 = {[3,2], [1]} = in_l(3, LRQ2),
    ?assertEqual(1, peek_r(LRQ3)),
    {1, LRQ4 = {[3], [2]}} = out_r(LRQ3),
    LRQ5 = {[4,3], [2]} = in_l(4, LRQ4),
    {2, LRQ6} = out_r(LRQ5),
    {3, LRQ7 = {[4], []}} = out_r(LRQ6),
    {4, LRQ8} = out_r(LRQ7),
